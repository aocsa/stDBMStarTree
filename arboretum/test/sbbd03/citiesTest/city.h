   ...
   public:
      ...
      */
      stDistance GetDistance(TCity *obj1, TCity *obj2){
         double lat1, lat2, long1, long2, parcidist;
         ...
         parcidist = acos(sin(lat1 * M_PI / 180) * sin(lat2 * M_PI / 180) +
               cos(lat1 * M_PI / 180) * cos(lat2 * M_PI / 180) *
               cos(long2 * M_PI / 180 - long1 * M_PI / 180));
         return 6370 * parcidist;
      }//end GetDistance
