//---------------------------------------------------------------------------
// city.cpp - This is a small example of use of the GBDI SlimTree Library.
//
...
int main(int argc, char* argv[]){
   ...
   if (argc==10){
     ...
     app.Run(argv[8], argv[9]);
      ...
      cout << "\nUsage: Cities PAGESIZE DATASETSIZE DIMFRACTAL RADIUSTREE PREFIX SOURCEDATA SOURCEQUERYDATA RANGE DIFRADIUS PERCRADIUS THIRD";
