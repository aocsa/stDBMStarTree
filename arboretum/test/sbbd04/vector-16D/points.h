...
//---------------------------------------------------------------------------
/**
* This class abstracts a vetor that holds values of EigenFaces.
*
...
class TPoint{
   public:
      /**
      * Default constructor. It creates a TPoint with values set to 0.
...
* the distance between two EigenFaces by performing a euclidean distance between
* point in EigenFaces.
*
