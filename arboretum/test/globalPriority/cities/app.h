...
#define NROOBJECTS 5507
#define DIMENSAOFRACTAL1 1.81
#define DIMENSAOFRACTAL2 5
...
class TApp{
   public:
      ...
      */
      typedef stGenericPriorityQueue < TCity > tGenericPriorityQueue;

      /**
      * This type is used by the priority key.
      */
      typedef stGenericPriorityHeap < TCity > tPGenericHeap;
