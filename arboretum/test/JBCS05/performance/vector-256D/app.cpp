...
void TApp::PerformQueries(){
   ...
   gnuTestRQ->SetTitle(GNUPlot::DISTFUNCTION, "RQ: Synt256D");
   gnuTestRQ->SetTitle(GNUPlot::DISKACCESS, "RQ: Synt256D");
   gnuTestRQ->SetTitle(GNUPlot::TOTALTIME, "RQ: Synt256D");
   ...
   gnuTestkNNQ->SetTitle(GNUPlot::DISTFUNCTION, "kNNQ: Synt256D");
   gnuTestkNNQ->SetTitle(GNUPlot::DISKACCESS, "kNNQ: Synt256D");
   gnuTestkNNQ->SetTitle(GNUPlot::TOTALTIME, "kNNQ: Synt256D");
