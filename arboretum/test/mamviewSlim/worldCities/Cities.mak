...
# ---------------------------------------------------------------------------
PROJECT = cities.exe
OBJFILES = main.obj app.obj city.obj
RESFILES = 
...
USERDEFINES = __stMAMVIEW__;__stDEBUG__
SYSDEFINES = NO_STRICT;_NO_VCL;_RTLDLL;USEPACKAGES
INCLUDEPATH = $(BCB)\include;$(BCB)\include\vcl;..\..\..\include
LIBPATH = $(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
# ---------------------------------------------------------------------------
CFLAG1 = -O2 -H=$(BCB)\lib\vcl50.csm -Hc -Vx -Ve -X- -a8 -b- -k- -vi -tWC -tWM -c
IDLCFLAGS = -I$(BCB)\include -I$(BCB)\include\vcl -I..\..\..\include -src_suffix cpp \
    -D__stMAMVIEW__ -D__stDEBUG__ -boa
