...
void __fastcall TForm1::SlimTree1Click(TObject *Sender)
{
   ...
   LoadTree("..\\..\\sample\\sample-02_SlimTree\\cities500.txt");
   // Configure the MAMView
   SlimTree->MAMViewInit();
   SlimTree->MAMViewSetOutputDir("");
   // Load the sample vector with objects in this file.
   LoadSample("..\\..\\sample\\sample-02_SlimTree\\cities500.txt");
...
//---------------------------------------------------------------------------
void __fastcall TForm1::Dump1Click(TObject *Sender){

   if (SlimTree != NULL){
      SlimTree->MAMViewDumpTree();
   }//end if
}//end TForm1::Dump1Click
//---------------------------------------------------------------------------
