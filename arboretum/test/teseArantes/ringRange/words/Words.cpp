...
int main(int argc, char* argv[]){
   ...
   if (argc >= 8){
      // Init application.
      app.Init(atoi(argv[1]), atoi(argv[2]), atoi(argv[3]), atoi(argv[4]), argv[5]);
      // Run it.
      app.Run(argv[6], argv[7]);
   }else{
      cout << "The arguments are wrong!";
      cout << "\nUsage: Words PAGESIZE STARTK NUMBEROFK STARTRANGE NUMBEROFRANGE TIELIST PREFIX SOURCEDATA SOURCEQUERYDATA";
      ...
      cout << "\n\nExample: Words 1024 5 6 1 10 false EG ../../../../../datasets/EnglishResto.txt ../../../../datasets/English500.txt";
   }//end if
