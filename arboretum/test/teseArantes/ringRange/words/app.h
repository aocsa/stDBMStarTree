...
class TApp{
   ...
   private:
      ...
      */
      void RingRange(ResultMeasureDiscrete * resultSlim, ResultMeasureDiscrete * resultDummy);

      void Range(ResultMeasureDiscrete * resultSlim, ResultMeasureDiscrete * resultDummy);
      ...
      * resultDummy the place to be save the results of Dummy.
      */
      void RingRangeIntersection(ResultMeasureDiscrete * resultSlim, ResultMeasureDiscrete * resultDummy);
      ...
      */
      void WriteToFile(FILE * file, char * algName, ResultMeasureDiscrete * rMeasure, int type);
