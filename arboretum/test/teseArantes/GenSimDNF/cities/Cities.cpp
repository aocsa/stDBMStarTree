//---------------------------------------------------------------------------
// cities.cpp - This is a test for Arantes' thesis.
//
...
int main(int argc, char* argv[]){
   ...
   if (argc >= 10){
      // Init application.
      app.Init(atoi(argv[1]), atof(argv[2]), atoi(argv[3]), atoi(argv[4]), atoi(argv[5]), argv[6]);
      // Run it.
      app.Run(argv[7], argv[8], argv[9], argv[10]);
   }else{
      cout << "The arguments are wrong!";
      cout << "\nUsage: Cities PAGESIZE K STARTRANGE NUMBEROFRANGE TIELIST PREFIX SOURCEDATA SOURCEQUERYDATA";
      cout << "\nPAGESIZE size of the page.";
      cout << "\nK number of nearest queries to be perfom.";
      ...
      cout << "\n\nExample: Cities 1024 5 6 1 10 false EG ../../../../../datasets/EnglishResto.txt ../../../../datasets/English500.txt";
   }//end if
