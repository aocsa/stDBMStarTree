...
int main(int argc, char* argv[]){
   ...
   if (argc > 9){
      // Init application.
      app.Init(atoi(argv[1]), atof(argv[2]), atoi(argv[3]), atoi(argv[4]), atoi(argv[5]), atoi(argv[6]), argv[7], argv[8]);
      // Run it.
      app.Run(argv[9], argv[10]);
   }else{
      cout << "The arguments are wrong!";
      cout << "\nUsage: metricHisto PAGESIZE STARTK NUMBEROFK STARTRANGE NUMBEROFRANGE TIELIST PREFIX SOURCEDATA SOURCEQUERYDATA";
      ...
      cout << "\n\nExample: metricHisto 1024 5 6 1 10 false EG ../../../../../datasets/EnglishResto.txt ../../../../datasets/English500.txt";
   }//end if
