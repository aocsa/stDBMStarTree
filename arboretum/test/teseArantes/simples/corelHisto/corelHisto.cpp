...
int main(int argc, char* argv[]){
   ...
   if (argc > 9){
      ...
      cout << "\nUsage: CorelHisto PAGESIZE STARTK NUMBEROFK STARTRANGE NUMBEROFRANGE TIELIST PREFIX SOURCEDATA SOURCEQUERYDATA";
      ...
      cout << "\n\nExample: CorelHisto 1024 5 6 1 10 false EG ../../../../../datasets/EnglishResto.txt ../../../../datasets/English500.txt";
   }//end if
