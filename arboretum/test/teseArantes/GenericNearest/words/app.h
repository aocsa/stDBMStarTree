...
class TApp{
   ...
   private:
      ...
      */
      void NearestQuery(ResultMeasureDiscrete * resultSlim, ResultMeasureDiscrete * resultDummy);
      ...
      * resultDummy the place to be save the results of Dummy.
      */
      void NearestIntersectionQuery(ResultMeasureDiscrete * resultSlim, ResultMeasureDiscrete * resultDummy);
